...
class Music:
    ...
    def getContent(self):
        ...
        if self.num == 0:
            self.mediaPath = os.path.join(os.getcwd(), "music/rain.mp3")
        elif self.num == 1:
            self.mediaPath = os.path.join(os.getcwd(), "music/fire.mp3")
        elif self.num == 2:
            self.mediaPath = os.path.join(os.getcwd(), "music/bird.mp3")
        else:
            self.mediaPath = os.path.join(os.getcwd(), "music/piano.mp3")
